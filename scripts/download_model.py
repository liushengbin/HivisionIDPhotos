...
def main(models_to_download):
    ...
    model_urls = {
        "hivision_modnet": {
            "url": "https://ghfast.top/https://github.com/Zeyi-Lin/HivisionIDPhotos/releases/download/pretrained-model/hivision_modnet.onnx",
            "format": "onnx",
            "location": "hivision/creator/weights",
        },
        "modnet_photographic_portrait_matting": {
            "url": "https://ghfast.top/https://github.com/Zeyi-Lin/HivisionIDPhotos/releases/download/pretrained-model/modnet_photographic_portrait_matting.onnx",
            "format": "onnx",
            "location": "hivision/creator/weights",
        },
        # "mnn_hivision_modnet": {
        ...
        "birefnet-v1-lite": {
            "url": "https://ghfast.top/https://github.com/ZhengPeng7/BiRefNet/releases/download/v1/BiRefNet-general-bb_swin_v1_tiny-epoch_232.onnx",
            "format": "onnx",
            "location": "hivision/creator/weights",
        },
        "retinaface-resnet50": {
            "url": "https://ghfast.top/https://github.com/Zeyi-Lin/HivisionIDPhotos/releases/download/pretrained-model/retinaface-resnet50.onnx",
            "format": "onnx",
